...
namespace UltrawideHelper.Data
{
    ...
    {
        public static readonly Dictionary<string, uint> Modifiers = new Dictionary<string, uint>
        {
        ...
        public static readonly Dictionary<string, uint> WindowStyles = new Dictionary<string, uint>
        {
        ...
        public static readonly Dictionary<string, uint> ExtendedWindowStyles = new Dictionary<string, uint>
        {
